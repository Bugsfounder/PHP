    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Fill All Fields For Signup</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/myreference/partials/_signuphandler.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input maxlength=12 type="number" class="form-control" id="phone" aria-describedby="phoneHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input maxlength=10 type="cpassword" name="cpassword" class="form-control" id="cpassword">
                    </div>
