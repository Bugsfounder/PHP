...
<body>
    ...
    <div class="container ">
        <h2 class="text-center my-3">iDiscuss - Browse Categorise</h2>

        <div class="row my-4">
            <!-- FETCH ALL THE CATEGORISE -->
            <!--  USE A FOR LOOP TO ITERATE THROUGH ALL THE CATEGORISE FROM DATABASE -->
            <?php
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            <div class="card" style="width: 18rem;">
                <img src="img/card_'.$id. '.jpg" class="card-img-top" alt="image for this category">
                <div class="card-body">
